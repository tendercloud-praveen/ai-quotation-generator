...
export default function ProductsPage() {
  ...
  // "manual" and "bulk" are mutually exclusive add modes.
  // null means the user has not selected an add method yet.
  ...
  return (
    <div className="space-y-6">
      ...
      {/* =================================================
          ...
          Add mode:
            1. Choose Manual or Bulk
            2. Only the selected action is enabled
          Edit mode:
            Existing product form is shown directly.
      ================================================= */}
      ...
      <Modal
        ...
        title={editingProduct ? "Edit Product" : "Add Products"}
        size="lg"
        footer={
          <>
            <Button
...
================================================= */}
        {!editingProduct && (
          <div className="mb-5">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Add one product manually or upload multiple products at once.
            </p>
      ...
      ================================= */}
              <button
                ...
                className={`group text-left rounded-lg border p-3 transition-all duration-200 ${
                  productMode === "manual"
                    ? "border-brand-500 bg-brand-50 ring-1 ring-brand-500"
                    : "border-slate-200 bg-white hover:border-brand-300 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:hover:border-brand-500"
                }`}
              >
                <div
                ...
                <p className="text-xs leading-5 text-slate-500 dark:text-slate-400 mt-0.5">
                  Add one product using the product details form.
                </p>
      ...
      ================================= */}
              ...
              >
                ...
                <p className="text-xs leading-5 text-slate-500 dark:text-slate-400 mt-0.5">
                  Upload a file containing multiple products.
                </p>
        ...
        {/* =================================================
            BULK UPLOAD CONTENT
        ================================================= */}
        {!editingProduct && productMode === "bulk" && (
          <div className="space-y-4">
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg p-5 text-center bg-slate-50/50 dark:bg-slate-900/30">
              {" "}
              ...
              <p className="mt-2 text-sm font-medium text-slate-700 dark:text-slate-200">
                {" "}
                {bulkFile ? bulkFile.name : "Upload Product File"}
              </p>
              <p className="text-xs text-slate-400 mt-1">
                {" "}
                Upload PDF, DOCX, JPG or PNG containing multiple products.
              </p>
              {/* Choose File Button */}
              <div className="mt-4">
                <label
                  className={`inline-flex ${
                    bulkFile ? "cursor-not-allowed" : "cursor-pointer"
                  }`}
                >
                  <span
              ...
              {/* Selected File */}
              {bulkFile && (
                <div className="mt-4 flex items-center justify-between gap-3 rounded-lg border border-green-200 bg-green-50 px-3 py-2.5 text-left">
                  ...
                  <button
                    ...
                    className="shrink-0 flex h-8 w-8 items-center justify-center rounded-md text-slate-400 transition hover:bg-red-100 hover:text-red-600"
                    title="Remove file"
            ...
            <p className="text-xs text-slate-400 text-center">
              The Add Product action is disabled while Bulk Upload mode is
              selected.
            </p>
          </div>
        )}
        ...
        {/* =================================================
            MANUAL FORM
        ================================================= */}
        {(editingProduct || (!editingProduct && productMode === "manual")) && (
        ...
        {/* No selection helper */}
        {!editingProduct && productMode === null && (
          <div className="rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 p-4 text-center">
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Select <span className="font-medium">Add Manually</span> or{" "}
              <span className="font-medium">Bulk Upload</span> to continue.
            </p>
          </div>
        )}
      </Modal>
