          ...
          <div className="space-y-4">
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg p-5 text-center bg-slate-50/50 dark:bg-slate-900/30">
              ...
              <label className="inline-flex mt-4">
                <span className="px-4 py-2.5 rounded-lg bg-brand-600 text-white text-sm font-medium cursor-pointer hover:bg-brand-700 transition">
                  {bulkFile ? "Choose Another File" : "Choose File"}
                </span>
