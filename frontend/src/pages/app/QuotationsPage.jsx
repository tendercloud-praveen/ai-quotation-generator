        ...
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1">
          {["all", ...STATUS_FLOW].map((s) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition ${statusFilter === s ? "bg-brand-600 text-white" : "bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700"}`}
            >
              {s === "all"
                ? "All"
                : s
            ...
            actions={(q) => (
              <div className="flex items-center justify-end gap-1">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg text-slate-400 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-950/40 transition"
                  title="Download PDF"
                >
                  <Download size={16} />
                </button>
                    ...
                    >
                      ...
                      <td className="px-3 py-2 text-right">
                        <input
                          ...
                          onChange={(e) =>
                            updateEditLine(i, { sellingPrice: +e.target.value })
                          }
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button onClick={confirmAssignManager}>
