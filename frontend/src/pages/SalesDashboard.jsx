...
const CARDS = [
  { label: "New Inquiries", value: "—", delta: "Capture a new lead", icon: "M10 4a1 1 0 011 1v4h4a1 1 0 110 2h-4v4a1 1 0 11-2 0v-4H5a1 1 0 110-2h4V5a1 1 0 011-1z", tone: "brand" },
  { label: "My Quotations", value: "—", delta: "All quotations you created", icon: "M6 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6l-4-4H6zm6 1.5L16.5 8H12V3.5zM7 11h10v1H7v-1zm0 3h10v1H7v-1z", tone: "emerald" },
  { label: "Pending Approval", value: "—", delta: "Awaiting manager review", icon: "M10 2a8 8 0 100 16 8 8 0 000-16zm1 11H9v-2h2v2zm0-3.5H9V6h2v3.5z", tone: "amber" },
  { label: "Approved Quotations", value: "—", delta: "Ready to send", icon: "M10 2a8 8 0 100 16 8 8 0 000-16zm3.7 6.3a1 1 0 00-1.4-1.4L9 10.2 7.7 8.9a1 1 0 10-1.4 1.4l2 2a1 1 0 001.4 0l4-4z", tone: "violet" },
];
...
const TASKS = [
  { title: "Log a new inquiry", desc: "Capture customer details to start a quotation.", time: "Start here", tone: "brand" },
  { title: "Draft quotations", desc: "Turn your inquiries into quotations for approval.", time: "In progress", tone: "amber" },
  { title: "Track approvals", desc: "See which quotations your manager has approved.", time: "Monitor", tone: "emerald" },
];
...
export default function SalesDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <h1 className="mt-3 text-2xl font-bold tracking-tight text-white sm:text-3xl">
              Welcome back, {user?.fullName?.split(" ")[0] || "Rep"}
            </h1>
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-ink-300">
              Capture inquiries, generate quotations, and send them for
              approval. Track the status of every quotation you create.
            </p>
          </div>
        </div>
      </div>

      {/* Sales rep info cards */}
      ...
      {/* Tasks */}
      <div>
        <h2 className="mb-4 text-sm font-semibold uppercase tracking-wide text-ink-500 dark:text-ink-400">Your workflow</h2>
