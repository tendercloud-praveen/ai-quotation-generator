...
from app.services.dashboard_service import get_total_quotations_count, get_pending_quotations_count, get_approved_quotations_count,get_dispatched_quotations_count, get_total_revenue_count, get_company_products_count, get_total_team_members_count, get_total_draft_quotations_count,get_total_margin_count
...
def get_quotations_count(
    ...
    total_margin = get_total_margin_count(
    db,
    company_id
)
    return {
