...
from app.repositories.quotation_revenue_trend_salesperson import DashboardRepository


class DashboardService:

    @staticmethod
    def get_salesperson_quotation_revenue_trend(
        db: Session,
        salesperson_id: int,
        company_id: int
    ):
        ...
        results = (
            DashboardRepository
            .get_salesperson_quotation_revenue(
                db=db,
